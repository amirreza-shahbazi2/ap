...
import java.util.stream.Collectors;
    ...
    public class HtmlAnalyzer {
        public static List<String> fileList = DirectoryTools.getFilesAbsolutePathInDirectory(Conf.SAVE_DIRECTORY);
...
//                System.out.println(urlCountEntry.getKey()+" -> "+urlCountEntry.getValue());
                ...
                for (String urlCountEntry : urlCounter.getTop(k)) {
                    System.out.println(urlCountEntry+" -> ");
            }
        }
